...
class BinaryOptionsTrader:
    def __init__(self):
        ...
        self.oscillation_file = '/home/ubuntu/013_2025_polymarket/bot004_blackScholes/latest_oscillation.json'
    ...
    def read_oscillation_data(self) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"Warning: {self.oscillation_file} not found")
            return None
        except json.JSONDecodeError:
            print(f"Warning: Error decoding {self.oscillation_file}")
            return None
