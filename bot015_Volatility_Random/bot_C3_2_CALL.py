#!/usr/bin/env python3
"""
Strategy C3_2 - ATR-Based Binary Options BTC_CALL Trader
...
pm2 start bot_C3_2.py --cron-restart="00 * * * *" --interpreter python3
"""
...
class StrategyC3_2Trader:
    """BTC_CALL trader with Strategy C3_2 (ATR-based, 1:3 ratio)"""
