...
RSI_PERIOD_MAX_C2 = 90  # Maximum period in seconds
...
def main():
    ...
    breach_history_a2 = deque(maxlen=100)  # Max ~100 breaches in 15 min
    ...
    breach_history_c2 = deque(maxlen=100)  # Max ~100 breaches in 15 min
        ...
        while True:
            ...
            if current_time_threshold - last_threshold_adjustment_time >= threshold_check_interval:
                ...
                rsi_period_c2, total_breaches_c2 = adjust_rsi_period(
                    ...
                    RSI_PERIOD_HIGH_TRIGGER_C2, RSI_PERIOD_LOW_TRIGGER_C2, RSI_PERIOD_MIN_C2, RSI_PERIOD_MAX_C2)
                rsi_period_samples_c2 = rsi_period_c2 * 10
