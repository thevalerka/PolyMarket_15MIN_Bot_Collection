...
pm2 start bot_choppiness_pullback_B.py --cron-restart="00 * * * *" --interpreter python3
"""
...
class ChoppinessPullbackBot:
    def __init__(self):
        ...
        self.trades_dir = f"{self.data_dir}/tradesB"
        self.state_file = f"{self.data_dir}/stateB.json"
