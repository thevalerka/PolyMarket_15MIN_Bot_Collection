...
pm2 start bot_choppiness_pullback_DBID.py --cron-restart="00 */6 * * *" --interpreter python3
"""
...
class ChoppinessPullbackBot:
    def __init__(self):
        ...
        self.trades_dir = f"{self.data_dir}/tradesDBID"
        self.state_file = f"{self.data_dir}/stateDBID.json"
        ...
        logger.info(f"✓ STRATEGY DBID - ADAPTIVE with BID/ASK EXECUTION")
        ...
        while True:
            try:
                ...
                if self.call_positions < self.current_max_positions:
                    pullback_weighted = self.current_pullback
