...
pm2 start bot_choppiness_pullback_C.py --cron-restart="00 */6 * * *" --interpreter python3
"""
...
class ChoppinessPullbackBot:
    def __init__(self):
        ...
        self.trades_dir = f"{self.data_dir}/tradesC"
        self.state_file = f"{self.data_dir}/stateC.json"
