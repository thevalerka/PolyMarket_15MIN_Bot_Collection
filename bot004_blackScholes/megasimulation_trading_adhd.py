...
class OptimalExitSimulation:
    def __init__(self, base_path="/home/ubuntu/013_2025_polymarket/"):
        ...
        self.results_file = os.path.join(base_path, "bot004_blackScholes/optimal_exit_results.json")
    ...
    def calculate_discrepancies(self, market_data):
        ...
        try:
            ...
            if not all([prob_data, call_data, put_data]):
                print("⚠️  Missing market data components")
                return None
            
            # Extract data with validation
            call_prob_bs = prob_data.get("call_probability")
            put_prob_bs = prob_data.get("put_probability")
            ...
            if None in [call_prob_bs, put_prob_bs, call_bid, call_ask, put_bid, put_ask]:
                print("⚠️  Incomplete market data - missing required fields")
                return None
            ...
            print(f"⚠️  Error calculating discrepancies: {e}")
            return None
    ...
    def run_simulation_cycle(self):
        ...
        if not market_data:
            print("⚠️  Market data unavailable - skipping this cycle")
        ...
        try:
            ...
            if not current_discrepancies:
                print("⚠️  Could not calculate discrepancies - skipping this cycle")
                return True
            ...
            print(f"⚠️  Error in simulation cycle: {e}")
            print("📊 Continuing simulation - will retry next cycle...")
            return True  # Don't crash, just continue
