...
class EnhancedBinaryOptionCalculator:
    def __init__(self, price_file_path="/home/ubuntu/013_2025_polymarket/eth_price.json"):
        self.price_file_path = price_file_path
        self.risk_free_rate = 0.05
        self.results_file = "/home/ubuntu/013_2025_polymarket/eth_option_probabilities.json"
    ...
    def get_current_price(self):
        """Read current ETH price from JSON file"""
        try:
    ...
    def fetch_binance_klines(self, hours=168):
        ...
        try:
            url = f"https://api.binance.com/api/v3/klines?symbol=ETHUSDT&interval=1h&limit={hours}"
    ...
    def fetch_binance_klines_1m(self, limit=720):
        ...
        try:
            url = f"https://api.binance.com/api/v3/klines?symbol=ETHUSDT&interval=1m&limit={limit}"
            with urllib.request.urlopen(url) as response:
                data = json.loads(response.read().decode())
            return data
        except Exception as e:
    ...
    def initialize_price_history_from_binance(self, hours=168):
        ...
        print(f"Fetching {hours} hours of ETH price history from Binance...")
    ...
    def calculate_ewma_volatility(self, lookback_minutes=120, recent_emphasis_minutes=60, lambda_factor=0.94):
        ...
        return max(0.2, min(3.0, annual_volatility))
    ...
    def run_continuous(self):
        ...
        print("🚀 Starting Enhanced ETH Binary Option Continuous Monitor")
        print("=" * 70)
