...
STOP_LOSS = 0.10  # Stop if price moves 0.10 against us
TAKE_PROFIT = 0.20  # Take profit if price moves 0.20 in our favor
...
class Bot016Third:
    ...
    def __init__(self, credentials: dict):
        ...
        logger.info(f"Stop Loss: -${STOP_LOSS:.2f} price move | Take Profit: +${TAKE_PROFIT:.2f} price move")
