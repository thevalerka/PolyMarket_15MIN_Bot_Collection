...
TRADES_DIR = "/home/ubuntu/013_2025_polymarket/bot016_react/mm_trades_gainonlyc38"
...
POSITION_CHECK_INTERVAL = 0.5  # Check positions every 30s
...
class MarketMakerBotGainOnly:
    ...
    def update_market_making_orders(self, call_bid: float, call_ask: float, put_bid: float, put_ask: float, btc_delta: float = 0):
        ...
        try:
            ...
            # NO EMERGENCY SELL - always wait for profit even if over max
