...
from py_clob_client.rfq import RfqClient
...
class ClobClient:
    ...
    def create_order(
        ...
        # print("Valerka TICKSIZE:", tick_size)
        """
        ...
        """
        neg_risk = False
        #print("Valerka NEgrisk:", neg_risk)
        """
        # fee rate
        ...
        """
        #print("Valerka feerate:", fee_rate_bps)
        fee_rate_bps = 1000
        order_args.fee_rate_bps = fee_rate_bps

        # print("Valerka PRICE:", order_args.price)
        # print("Valerka SIZE:", order_args.size)
        # print("Valerka SIDE:", order_args.side)
        # print("Valerka tokenid:", order_args.token_id)
        ...
        Valerka TICKSIZE: 0.01
        Valerka NEgrisk: False
        Valerka NEgrisk: 1000
        """
