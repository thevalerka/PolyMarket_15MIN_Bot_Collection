...
class PolymarketAPITokenCleaner:
    ...
    def __init__(self):
        ...
        self.api_url = 'https://data-api.polymarket.com/activity?user=0x51a02132af17252e6993c3b668ea462d46234a02&limit=50'
    ...
    def _initialize_trader(self) -> PolymarketTrader:
        ...
        try:
            # Use same credentials as main bot - Updated to keys_ovh39.env
