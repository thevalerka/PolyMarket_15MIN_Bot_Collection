...
class BitcoinHourlyMarketBot:
    ...
    def __init__(self, config_path: str = None):
        ...
        self.condition_threshold_seconds = 3  # 10 seconds
    ...
    def _load_config(self, config_path: str) -> Dict:
        ...
        default_config = {
            ...
            'eth_data_file': '/home/ubuntu/013_2025_polymarket/eth_price.json',
            'call_data_file': '/home/ubuntu/013_2025_polymarket/CALL_ETH.json',
            'put_data_file': '/home/ubuntu/013_2025_polymarket/PUT_ETH.json',
            'probability_file': '/home/ubuntu/013_2025_polymarket/eth_option_probabilities.json'
        }
    ...
    def get_probability_data(self) -> Optional[Dict]:
        """Read probability data from eth_option_probabilities.json"""
        ...
        if not self.check_data_freshness(prob_data, 'eth_option_probabilities.json'):
    ...
    def evaluate_market_conditions(self, prob_data: Dict, call_data: Dict, put_data: Dict):
        ...
        print("CALL prob-ask:",call_prob," - ", call_ask, " | PUT prob-ask:", put_prob," - ", put_ask)
        ...
        print("put_buy_condition:", put_buy_condition_met, " :", put_ask, "+ ", offset, "<", put_prob)
    ...
    def execute_trading_strategy(self):
        ...
        try:
            ...
            if not self.check_data_freshness(call_data, 'CALL_ETH.json'):
                logger.warning("CALL market data is stale, suspending trading")
                return

            if not self.check_data_freshness(put_data, 'PUT_ETH.json'):
