...
class BitcoinHourlyMarketBot:
    ...
    def __init__(self, config_path: str = None):
        ...
        self.condition_threshold_seconds = 5.0  # 10 seconds
    ...
    def _load_config(self, config_path: str) -> Dict:
        ...
        default_config = {
            ...
            'btc_data_file': '/home/ubuntu/013_2025_polymarket/eth_price.json',
            'call_data_file': '/home/ubuntu/013_2025_polymarket/CALL_ETH.json',
            'put_data_file': '/home/ubuntu/013_2025_polymarket/PUT_ETH.json',
            'probability_file': '/home/ubuntu/013_2025_polymarket/option_probabilities_ETH.json'
        }
    ...
    def get_probability_data(self) -> Optional[Dict]:
        """Read probability data from option_probabilities_ETH.json"""
        ...
        if not self.check_data_freshness(prob_data, 'option_probabilities_ETH.json'):
...
if __name__ == "__main__":
    ...
    print("• Read probabilities from option_probabilities_ETH.json")
    ...
    print("  3. Reload CALL_ETH.json and PUT_ETH.json")
